...
const cp_298_molar = Cp_T({ component: hydrogen, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'molar' });
logAndCapture('Cp(T=298.15 K, molar):', cp_298_molar);

const cp_298_mass = Cp_T({ component: hydrogen, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'mass' });
...
const h2o_1500 = H_T({ component: water, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('H(T=1500 K):', h2o_1500);

const s2o_1500 = S_T({ component: water, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('S(T=1500 K):', s2o_1500);

const g2o_1500 = G_T({ component: water, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('G(T=1500 K):', g2o_1500);

const cp2o_298_molar = Cp_T({ component: water, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'molar' });
logAndCapture('Cp(T=298.15 K, molar):', cp2o_298_molar);

const cp2o_298_mass = Cp_T({ component: water, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'mass' });
...
const ch4_1500 = H_T({ component: methane, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('H(T=1500 K):', ch4_1500);

const s_ch4_1500 = S_T({ component: methane, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('S(T=1500 K):', s_ch4_1500);

const g_ch4_1500 = G_T({ component: methane, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('G(T=1500 K):', g_ch4_1500);

const cp_ch4_298_molar = Cp_T({ component: methane, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'molar' });
logAndCapture('Cp(T=298.15 K, molar):', cp_ch4_298_molar);

const cp_ch4_298_mass = Cp_T({ component: methane, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'mass' });
...
const cp_co2_298_mass = Cp_T({ component: carbon_dioxide, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'mass' });
...
const c2h6o_1500 = H_T({ component: ethanol, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('H(T=1500 K):', c2h6o_1500);

const s_c2h6o_1500 = S_T({ component: ethanol, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('S(T=1500 K):', s_c2h6o_1500);

const g_c2h6o_1500 = G_T({ component: ethanol, temperature: temperature1500, model_source: component_model_source, component_key: componentKey });
logAndCapture('G(T=1500 K):', g_c2h6o_1500);

const cp_c2h6o_298_molar = Cp_T({ component: ethanol, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'molar' });
logAndCapture('Cp(T=298.15 K, molar):', cp_c2h6o_298_molar);

const cp_c2h6o_298_mass = Cp_T({ component: ethanol, temperature: temperature298, model_source: component_model_source, component_key: componentKey, basis: 'mass' });
...
const dH = dH_rxn_STD({ reaction, temperature: reactionTemperature, model_source: component_model_source, component_key: componentKey });
logAndCapture('dH_rxn_STD:', dH);

const dS = dS_rxn_STD({ reaction, temperature: reactionTemperature, model_source: component_model_source, component_key: componentKey });
logAndCapture('dS_rxn_STD:', dS);

const dG = dG_rxn_STD({ reaction, temperature: reactionTemperature, model_source: component_model_source, component_key: componentKey });
logAndCapture('dG_rxn_STD:', dG);

const KeqVal = Keq({ reaction, temperature: reactionTemperature, model_source: component_model_source, component_key: componentKey });
logAndCapture('Keq:', KeqVal);

const KeqVH = Keq_vh_shortcut({ reaction, temperature: reactionTemperature, model_source: component_model_source, component_key: componentKey });
...
const dH_2 = dH_rxn_STD({ reaction: reaction_2, temperature: reactionTemperature_2, model_source: component_model_source, component_key: componentKey });
logAndCapture('dH_rxn_STD:', dH_2);

const dS_2 = dS_rxn_STD({ reaction: reaction_2, temperature: reactionTemperature_2, model_source: component_model_source, component_key: componentKey });
logAndCapture('dS_rxn_STD:', dS_2);

const dG_2 = dG_rxn_STD({ reaction: reaction_2, temperature: reactionTemperature_2, model_source: component_model_source, component_key: componentKey });
logAndCapture('dG_rxn_STD:', dG_2);

const KeqVal_2 = Keq({ reaction: reaction_2, temperature: reactionTemperature_2, model_source: component_model_source, component_key: componentKey });
logAndCapture('Keq:', KeqVal_2);

const KeqVH_2 = Keq_vh_shortcut({ reaction: reaction_2, temperature: reactionTemperature_2, model_source: component_model_source, component_key: componentKey });
